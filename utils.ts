...
// CONFIGURAZIONE API
// Su Vercel usiamo un percorso relativo.
// Quando sei in locale (npm start), le API di Vercel non funzionano a meno che non usi 'vercel dev'.
// In produzione su Vercel funzionerà automaticamente.
...
export const deleteSubmission = async (id: string): Promise<boolean> => {
    try {
         // Passiamo l'ID come query param
